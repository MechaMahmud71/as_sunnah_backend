...
export class NewMigrations1738082084127 implements MigrationInterface {
    name = 'NewMigrations1738082084127'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "donations" ("id" SERIAL NOT NULL, "amount" numeric NOT NULL, "donationTime" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "message" character varying NOT NULL DEFAULT '', "userId" integer, CONSTRAINT "PK_c01355d6f6f50fc6d1b4a946abf" PRIMARY KEY ("id"))`);
